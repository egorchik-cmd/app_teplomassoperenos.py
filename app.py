...
def fig_temperature(res,Tp,tau):
    T_sn, t_sn = res["T_sn"], res["t_sn"]
    i3 = res["i3"]
    i_mid = i3 + (len(res["x"]) - i3) // 2
    Tf = T_sn[:, i_mid]
    fig, ax = plt.subplots(figsize=(7.5, 4.5))
    fig.patch.set_facecolor("white"); ax.set_facecolor("white")
    ax.plot(t_sn, Tf, color="#1565c0", lw=2.5, zorder=3, label=f"{Tp} \u00b0C / {tau} \u0441")
    pts = np.unique(np.round(np.linspace(0, len(t_sn)-1, min(8, len(t_sn)))).astype(int))
    for i in pts:
        ax.annotate(f"{Tf[i]:.0f}", xy=(t_sn[i], Tf[i]),
            fontsize=8, color="#1565c0", fontweight="bold",
            ha="center", va="bottom", xytext=(0, 5), textcoords="offset points")
    ax.annotate("20", xy=(0, T0), fontsize=8, color="#333",
                ha="center", va="top", xytext=(0, -8), textcoords="offset points")
    ax.set_xlabel("\u0412\u0440\u0435\u043c\u044f t, \u0441\u0435\u043a", fontsize=10, labelpad=5)
    ax.set_ylabel("T, \u00b0C", fontsize=10, labelpad=5)
    ax.set_title(
        f"\u0420\u0438\u0441. 4.1 \u2014 \u0422\u0435\u043c\u043f\u0435\u0440\u0430\u0442\u0443\u0440\u0430 \u0442\u043a\u0430\u043d\u0438 T(t)\n"
        f"\u0420\u0435\u0436\u0438\u043c {Tp} \u00b0C / {tau} \u0441",
        fontsize=11, fontweight="bold")
    ax.set_xlim(-1, tau * 1.05)
    ax.set_ylim(0, max(Tp * 1.08, TG + 20))
    ax.legend(fontsize=9, loc="lower right", framealpha=0.95, edgecolor="#ddd")
    ax.grid(True, alpha=0.3, ls="--", color="#ccc")
    ax.spines[["top", "right"]].set_visible(False)
    return fig

def fig_concentration(res,Tp,tau):
    r, C_fin, Rf = res["r"], res["C_fin"], res["R_fiber"]
    r_um = r * 1e6
    fig, ax = plt.subplots(figsize=(7.5, 4.5))
    fig.patch.set_facecolor("white"); ax.set_facecolor("white")
    if res["fiber"] == "SILK":
        r_s = np.linspace(0, Rf * 1e6, 20)
        ax.plot(r_s, np.zeros_like(r_s), color="#555", lw=2.5, ls="--",
                marker="o", markersize=4, markevery=5,
                label="\u0428\u0451\u043b\u043a (\u0432\u0441\u0435 \u0440\u0435\u0436\u0438\u043c\u044b): C = 0")
        for i, rv in enumerate(r_s):
            if i % 5 == 0:
        ...
        ax.text(0.5, 0.5,
            "\u0428\u0451\u043b\u043a \u043d\u0435\u043f\u0440\u043e\u043d\u0438\u0446\u0430\u0435\u043c\n"
            "(\u0413\u0423 \u041d\u0435\u0439\u043c\u0430\u043d\u0430, \u0443\u0440. 3.13)\n\n"
            "\u041a\u0440\u0430\u0441\u0438\u0442\u0435\u043b\u044c \u043e\u0441\u0442\u0430\u0451\u0442\u0441\u044f \u043d\u0430 \u043f\u043e\u0432\u0435\u0440\u0445\u043d\u043e\u0441\u0442\u0438 \u0432\u043e\u043b\u043e\u043a\u043d\u0430",
            ha="center", va="center", fontsize=11, color="#e65100",
            transform=ax.transAxes,
            bbox=dict(boxstyle="round,pad=0.6", fc="#fff8e1", ec="#fb8c00"))
    else:
        ax.plot(r_um, C_fin, color="#1565c0", lw=2.5,
                marker="o", markersize=4, markevery=5,
                label=f"\u041f\u042d\u0422 {Tp} \u00b0C / {tau} \u0441", zorder=3)
        ax.fill_between(r_um, 0, C_fin, alpha=0.10, color="#1565c0")
        for i, (rv, cv) in enumerate(zip(r_um, C_fin)):
            if i % 5 == 0:
                ax.annotate(f"{cv:.1f}", xy=(rv, cv),
                    fontsize=7, color="#1565c0", fontweight="bold",
                    ha="center", va="bottom", xytext=(0, 4), textcoords="offset points")
        ax.plot(0, res["C_axis"], "r*", ms=14, zorder=5,
                label=f"\u041e\u0441\u044c: C/Cs = {res['C_axis']:.3f}")
    ax.set_xlabel(
        f"r, \u043c\u043a\u043c  (0 = \u043e\u0441\u044c \u0432\u043e\u043b\u043e\u043a\u043d\u0430,  {Rf*1e6:.1f} \u043c\u043a\u043c = \u043f\u043e\u0432\u0435\u0440\u0445\u043d\u043e\u0441\u0442\u044c)",
        fontsize=10, labelpad=5)
    ax.set_ylabel("C/Cs", fontsize=10, labelpad=5)
    ax.set_title(
        f"\u0420\u0438\u0441. 4.2 \u2014 \u041f\u0440\u043e\u0444\u0438\u043b\u044c \u043a\u043e\u043d\u0446\u0435\u043d\u0442\u0440\u0430\u0446\u0438\u0438 C(r)\n"
        f"\u0420\u0435\u0436\u0438\u043c {Tp} \u00b0C / {tau} \u0441",
        fontsize=11, fontweight="bold")
    ax.set_xlim(-0.2, Rf * 1e6 + 0.5)
    ax.set_ylim(-0.05, 1.12)
    ax.legend(fontsize=9, loc="upper left" if res["fiber"]=="PET" else "lower right",
